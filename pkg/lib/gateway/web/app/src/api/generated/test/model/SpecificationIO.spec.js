...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KantokuApi.SpecificationIO();
  });
  ...
  describe('SpecificationIO', function() {
    it('should create an instance of SpecificationIO', function() {
      // uncomment below and update the code to test SpecificationIO
      //var instance = new KantokuApi.SpecificationIO();
      //expect(instance).to.be.a(KantokuApi.SpecificationIO);
    });
