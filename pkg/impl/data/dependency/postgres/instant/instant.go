...
func (d *Deps) NewDependency(_ context.Context) (deps2.Dependency, error) {
	id := uuid.New().String()
...
func (d *Deps) InitGroup(ctx context.Context, groupId string, depIds ...string) error {
	...
	if pending == 0 {
		// all dependency have already been resolved
...
func (d *Deps) Resolve(ctx context.Context, dep string) error {
	...
	// we also return groups which have no unresolved dependency
	sql = `
